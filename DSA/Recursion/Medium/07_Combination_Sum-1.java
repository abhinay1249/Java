...
// Note that 2 can be used multiple times. 7 is a candidate, and 7 = 7. These are the only two combinations.
...
class Main {
    ...
    // ====================================== Recursive Approach ======================================
        ...
        private static List<List<Integer>> recursiveCombinationSum(int index, List<List<Integer>> al, int target, int[] nums, List<Integer> ds){
            ...
            recursiveCombinationSum(index+1, al, target, nums, ds);             // T.C = O(2^T * K), S.C = O(K * X) , where k is the average length of every combination that gets inserted
